          ...
          <Grid item xs={12} md={9}>
            <Typography
              ...
              sx={{
                textAlign: "left",
                fontSize: {
                  xs: "1rem", // สำหรับหน้าจอที่มีความกว้างน้อยกว่า 360px
                  360: "1.1rem", // สำหรับหน้าจอที่กว้าง 360px
                  390: "1.2rem", // สำหรับหน้าจอที่กว้าง 390px
                  428: "1.3rem", // สำหรับหน้าจอที่กว้าง 428px
                  430: "1.4rem", // สำหรับหน้าจอที่กว้าง 430px
                  md: "1.5rem", // สำหรับหน้าจอขนาดปานกลาง
                  lg: "1.7rem", // สำหรับหน้าจอใหญ่
                },
                fontWeight: 600,
                whiteSpace: "nowrap", // บังคับให้ข้อความอยู่ในบรรทัดเดียว
                overflow: "hidden", // ซ่อนข้อความส่วนที่เกินออกไป
                textOverflow: "ellipsis", // เพิ่มจุดไข่ปลาเพื่อแสดงว่ามีข้อความเพิ่มเติม
                maxWidth: "100%", // ควบคุมไม่ให้ข้อความยาวเกินขอบของคอนเทนเนอร์
              }}
            >
