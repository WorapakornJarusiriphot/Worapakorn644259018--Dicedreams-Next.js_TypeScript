...
const validationSchema = Yup.object().shape({
  nameGames: Yup.string().required('กรุณากรอกชื่อโพสต์').max(100, 'ชื่อโพสต์ต้องไม่เกิน 100 ตัวอักษร'),
  detailPost: Yup.string().required('กรุณากรอกรายละเอียดของโพสต์').max(500, 'รายละเอียดของโพสต์ต้องไม่เกิน 500 ตัวอักษร'),
