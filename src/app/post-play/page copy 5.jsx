          ...
          >
            ...
            >
              {({
                ...
                // ใช้ useEffect เพื่อตรวจสอบข้อผิดพลาดและเลื่อนหน้าไปยังฟิลด์ที่มีปัญหา
                // eslint-disable-next-line react-hooks/rules-of-hooks
                useEffect(() => {
                  if (Object.keys(errors).length > 0) {
                    const firstErrorKey = Object.keys(errors)[0]; // ดึง key ของฟิลด์แรกที่มีข้อผิดพลาด
                    const errorElement = errorRefs[firstErrorKey]?.current;
                
                    if (firstErrorKey && errorElement && typeof errorElement.scrollIntoView === "function") {
                      // หน่วงการทำงานเล็กน้อยเพื่อให้ DOM ถูก render เสร็จก่อน
                      setTimeout(() => {
