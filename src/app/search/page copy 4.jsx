    ...
    if (search) {
      const fetchData = async () => {
        try {
          ...
          // กรองข้อมูลที่มีค่า search ที่ตรงกัน
          const filteredActivities = activitiesData.filter(activity =>
            activity.name_activity.toLowerCase().includes(search.toLowerCase()) ||
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={8}>
              {activities.length > 0 ? (
                ...
                <Typography color="white">ไม่พบกิจกรรมที่ตรงกับคำค้นหา</Typography>
              )}
              {games.length > 0 ? (
                games.map((game) => (
                ...
                <Typography color="white">ไม่พบโพสต์นัดเล่นที่ตรงกับคำค้นหา</Typography>
              )}
            </Grid>
          </Grid>
        </Container>
