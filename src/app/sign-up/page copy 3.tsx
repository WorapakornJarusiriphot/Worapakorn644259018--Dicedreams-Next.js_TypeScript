...
export default function SignUp() {
  ...
  const handleClose = (event: React.SyntheticEvent | Event, reason?: string) => {
    ...
    console.log('Closing alert:', alertState);
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log('Alert state after success:', { open: true, message: 'User registration successful!', severity: 'success' });
    } catch (error) {
      console.error("Error signing up: ", error);
      setAlertState({ open: true, message: 'Failed to register. Please check your details and try again.', severity: 'error' });
      console.log('Alert state after error:', { open: true, message: 'Failed to register. Please check your details and try again.', severity: 'error' });
    }
  };
