  ...
  useEffect(() => {
    ...
    const fetchStoreData = async () => {
      try {
        ...
        const userResponse = await axios.get(`https://dicedreams-backend-deploy-to-render.onrender.com/api/users/${user.users_id}`, {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          }
        });

        const storeResponse = await axios.get(`https://dicedreams-backend-deploy-to-render.onrender.com/api/store/${userResponse.data.users_id}`, {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          }
        });
