  ...
  return (
    <Box sx={{ width: '100%', ...sx }}>
      {sortedStores.map((store, index) => (
        <Card key={store.store_id} sx={{ display: 'flex', alignItems: 'center', marginBottom: 2, padding: 2 }} onClick={() => handleCardClick(store.store_id)}>
          <ListItemAvatar>
            <Avatar
      ...
      {sortedUsers.map((user, index) => (
        <Card key={user.users_id} sx={{ display: 'flex', alignItems: 'center', marginBottom: 2, padding: 2 }} onClick={() => handleCardClick(user.users_id)}>
          <ListItemAvatar>
            <Avatar
              src={user.user_image}
