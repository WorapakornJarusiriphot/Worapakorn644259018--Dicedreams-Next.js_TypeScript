                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      fontSize: isSmallMobile
                        ...
                        : isMobile
                          ? "12px"
                          : "18px", // เพิ่มขนาดตัวอักษรเมื่อหน้าจอใหญ่ขึ้น
                      padding: isSmallMobile
                        ? "4px 6px"
                        : isMobile
                          ? "6px 8px"
                          : "10px 20px", // เพิ่ม padding ให้ปุ่มใหญ่ขึ้นในหน้าจอใหญ่
                      minWidth: isSmallMobile ? "auto" : "100px", // ขนาดปุ่มขั้นต่ำ
                      maxWidth: isMobile ? "120px" : "auto", // ยืดขนาดให้เหมาะกับหน้าจอใหญ่
                      whiteSpace: "nowrap", // ป้องกันการตัดคำในปุ่ม
                      overflow: "hidden",
