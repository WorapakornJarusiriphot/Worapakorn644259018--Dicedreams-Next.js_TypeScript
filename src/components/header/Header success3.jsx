                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      fontSize: isSmallMobile
                        ...
                        : isMobile
                          ? "12px"
                          : "14px", // ปรับขนาดตัวอักษรให้เล็กลง
                      padding: isSmallMobile ? "4px 6px" : "6px 8px", // ลด padding สำหรับหน้าจอเล็ก
                      minWidth: isSmallMobile ? "auto" : "100px", // ปรับขนาดปุ่มให้เหมาะสมกับหน้าจอเล็ก
                      maxWidth: "120px", // จำกัดความกว้างของปุ่ม
                      whiteSpace: "nowrap", // ป้องกันไม่ให้ข้อความตัดคำ
                      overflow: "hidden",
                      textOverflow: "ellipsis", // ใช้ข้อความเป็น ... หากข้อความยาวเกินไป
                    }}
                    href="/post-activity"
                    replace="true"
                  >
