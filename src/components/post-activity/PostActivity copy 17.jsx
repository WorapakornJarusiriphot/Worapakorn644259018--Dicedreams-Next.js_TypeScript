        ...
        if (accessToken) {
          ...
          const postsWithStores = postsData
            ...
            .map((post) => {
              ...
              const rawCreationDate = post.creation_date
                ? parseISO(post.creation_date)
                : null;
              if (rawCreationDate && !isValid(rawCreationDate)) {
              ...
              return {
                ...
                creation_date: post.creation_date
                  ...
                  : "Invalid date",
                date_activity: post.date_activity
                  ? formatThaiDate(post.date_activity)
                  : "Invalid date",
                time_activity: post.time_activity
                  ? formatThaiTime(post.time_activity)
                  : "Invalid time",
                isPast: isPast,
              };
            });
