      ...
      {items.map((item) => (
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            ...
            {item.isPast && (
              <div
                className="rounded-full bg-black/[0.65] flex justify-center items-center text-xs/sp14 text-white h-[3.75rem] w-[3.875rem] absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 z-20"
              >
                สินค้าหมด
              </div>
            )}
