...
function renderContent(notification) {
  ...
  if (notification.type === "participate") {
    message = `มีผู้ใช้เข้าร่วมโพสต์นัดเล่นของคุณ: 
      เกม: ${notification.data.name_games}, 
      รายละเอียด: ${notification.data.detail_post}, 
      จำนวนคนจะไป: ${notification.data.participants}/${notification.data.num_people}, 
      วันที่เจอกัน: ${formatThaiDate(notification.data.date_meet)}, 
      เวลาที่เจอกัน: ${formatThaiTime(notification.data.time_meet)}`;
