...
function PostGameDetail() {
  ...
  // สร้าง state เพื่อเก็บข้อมูลว่า chat ไหนที่เรากำลังแก้ไข
  const [editingChatId, setEditingChatId] = useState(null);
  const [editedMessage, setEditedMessage] = useState("");

  // ฟังก์ชันสำหรับแสดง TextField เมื่อกดปุ่ม "แก้ไขพูดคุย"
  const handleEditChat = (chat) => {
    setEditingChatId(chat.chat_id); // กำหนด chat_id ที่กำลังแก้ไข
    setEditedMessage(chat.message); // กำหนดข้อความที่ถูกแก้ไขจากฐานข้อมูล
  };
            ...
            >
              <Box
                sx={{
                  ...
                  flexDirection: "row",
                  alignItems: "center",
                  justifyContent: "space-between", // จัดให้ข้อความอยู่ทางซ้ายสุด และไอคอนอยู่ขวาสุด
                }}
              >
                <div
                  onClick={
                ...
                <Grid item xs>
                  {" "}
                  {/* เพิ่มกล่องนี้เพื่อจัดการข้อความ */}
                  <div
                    onClick={
                      (event) =>
                        chat.user?.users_id
                ...
                <Grid item>
                  <div>
                    ...
                    <IconButton
                      ...
                      aria-label="settings"
                      onClick={
                        (event) => handleMenuClick(event, chat.chat_id, chat) // แก้ไขให้รับ chat.chat_id
                      }
                    >
                    ...
                    >
                      <MenuItem
                        onClick={
                          (event) => handleEditChat(chat) // แก้ไขให้เป็น chat แทน item
                        }
                      >
              ...
              {/* ถ้าเป็น chat ที่กำลังถูกแก้ไขให้แสดง TextField แทนข้อความ */}
