...
function PostGameDetail() {
  ...
  const handleEditChat = async (event, chat_id ,message) => {
    ...
    //   console.log("Selected post userId: ", selectedPost.users_id); // ตรวจสอบ users_id ของโพสต์
      ...
      setEditingChatId(chat_id); // เก็บ chat_id ของแชทที่กำลังแก้ไข
      setEditedMessage(message); // นำข้อความที่ต้องการแก้ไขมาแสดงใน TextField
    // } catch (error) {
