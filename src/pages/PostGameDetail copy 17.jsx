...
function PostGameDetail() {
  ...
  const fetchPostGame = async (gameId, accessToken) => {
    try {
      ...
      const postParticipants = participantsData.map((participant) => ({
      ...
      setPostData({
        ...data,
        participants: postParticipants.length,
        participantsList: postParticipants,
      });
    } catch (error) {
        ...
        <Container maxWidth="lg" sx={{ marginTop: 10 }}>
          ...
          >
            ...
            >
              ...
              <br />
              {postData?.participantsList?.map((participant) => (
                <Avatar
