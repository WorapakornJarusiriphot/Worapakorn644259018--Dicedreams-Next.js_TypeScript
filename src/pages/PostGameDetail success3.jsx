    ...
    try {
      ...
      if (response.ok) {
        ...
        setUser({
          ...
          profilePictureUrl: data.user_image ? constructImageUrl(data.user_image) : "",
        });
      } else {
      ...
      <ThemeProvider theme={darkTheme}>
        <Container maxWidth="lg" sx={{ marginTop: 10 }}>
          ...
          >
            ...
            >
              <img
                src={postData?.games_image ? constructImageUrl(postData.games_image) : "default-image-url.jpg"}
                alt="Game Image"
                style={{
                  width: "100%",
                  borderRadius: "10px",
              ...
              <Box sx={{ display: "flex", flexWrap: "wrap" }}>
                {participants.map((participant) => (
                  <Avatar
                    ...
                    src={
                      participant.user?.user_image ? constructImageUrl(participant.user.user_image) : "url-to-profile-picture.jpg"
                    }
                    sx={{
                      width: "50px",
                      height: "50px",
